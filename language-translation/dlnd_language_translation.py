...
def model_inputs():
    ...
    return input_, targets_, lr_, keep_prob, target_sequence_length, max_target_sequence_length, source_sequence_length
...
def decoding_layer(dec_input, encoder_state,
    ...
    # Training Decoder Using Function "decoding_layer_train()" Which was Constructed Before
...
def sentence_to_seq(sentence, vocab_to_int):
    ...
    seq = [vocab_to_int.get(word, vocab_to_int['<UNK>']) for word in sentence_lower.split()]
    return seq
